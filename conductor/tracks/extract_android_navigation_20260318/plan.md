...
- [ ] Task: Review current navigation graph assembly in `app/src/main/kotlin/org/meshtastic/app/navigation/`.
    - [ ] Identify dependencies between feature navigation graphs and core routing definitions.
    - [ ] Create missing directory structures in feature modules' `androidMain/kotlin/org/meshtastic/feature/*/navigation` if they don't exist.
