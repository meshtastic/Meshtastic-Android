        ...
        val updatedEnv =
            if (env != null) {
                env.copy(
                    ...
                    gas_resistance = env.gas_resistance ?: Float.NaN,
                    voltage = env.voltage ?: Float.NaN,
                    current = env.current ?: Float.NaN,
                    lux = env.lux ?: Float.NaN,
                    uv_lux = env.uv_lux ?: Float.NaN,
                    iaq = env.iaq ?: Int.MIN_VALUE,
                    soil_moisture = env.soil_moisture ?: Int.MIN_VALUE,
                )
            } else {
                null
            }
