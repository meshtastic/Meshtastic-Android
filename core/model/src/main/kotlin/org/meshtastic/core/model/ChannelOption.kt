...
private val Config.LoRaConfig.ModemPreset.bandwidth: Float
    get() {
...
enum class RegionInfo(
    val regionCode: Config.LoRaConfig.RegionCode,
    ...
    UNSET(Config.LoRaConfig.RegionCode.UNSET, "Please set a region", 902.0f, 928.0f),
     ...
     */
    US(Config.LoRaConfig.RegionCode.US, "United States", 902.0f, 928.0f),

    /** European Union 433MHz */
    EU_433(Config.LoRaConfig.RegionCode.EU_433, "European Union 433MHz", 433.0f, 434.0f),
     ...
     */
    EU_868(Config.LoRaConfig.RegionCode.EU_868, "European Union 868MHz", 869.4f, 869.65f),

    /** China */
    CN(Config.LoRaConfig.RegionCode.CN, "China", 470.0f, 510.0f),
     ...
     */
    JP(Config.LoRaConfig.RegionCode.JP, "Japan", 920.5f, 923.5f),
     ...
     */
    ANZ(Config.LoRaConfig.RegionCode.ANZ, "Australia / Brazil / New Zealand", 915.0f, 928.0f),
     ...
     */
    KR(Config.LoRaConfig.RegionCode.KR, "Korea", 920.0f, 923.0f),
     ...
     */
    TW(Config.LoRaConfig.RegionCode.TW, "Taiwan", 920.0f, 925.0f),
     ...
     */
    RU(Config.LoRaConfig.RegionCode.RU, "Russia", 868.7f, 869.2f),

    /** India */
    IN(Config.LoRaConfig.RegionCode.IN, "India", 865.0f, 867.0f),
     ...
     *   [IoT Spectrum in NZ Briefing Paper](https://iotalliance.org.nz/wp-content/uploads/sites/4/2019/05/IoT-Spectrum-in-NZ-Briefing-Paper.pdf)
     */
    NZ_865(Config.LoRaConfig.RegionCode.NZ_865, "New Zealand 865MHz", 864.0f, 868.0f),

    /** Thailand */
    TH(Config.LoRaConfig.RegionCode.TH, "Thailand", 920.0f, 925.0f),
     ...
     */
    UA_433(Config.LoRaConfig.RegionCode.UA_433, "Ukraine 433MHz", 433.0f, 434.7f),
     ...
     * @see [NKZRZI](https://nkrzi.gov.ua/images/upload/256/5810/PDF_UUZ_19_01_2016.pdf)
     */
    UA_868(Config.LoRaConfig.RegionCode.UA_868, "Ukraine 868MHz", 868.0f, 868.6f),
     ...
     */
    MY_433(Config.LoRaConfig.RegionCode.MY_433, "Malaysia 433MHz", 433.0f, 435.0f),
     ...
     * @see [MCMC](https://www.mcmc.gov.my/skmmgovmy/media/General/pdf/Short-Range-Devices-Specification.pdf)
     */
    MY_919(Config.LoRaConfig.RegionCode.MY_919, "Malaysia 919MHz", 919.0f, 924.0f),
     ...
     */
    SG_923(Config.LoRaConfig.RegionCode.SG_923, "Singapore 923MHz", 917.0f, 925.0f),
     ...
     */
    PH_433(Config.LoRaConfig.RegionCode.PH_433, "Philippines 433MHz", 433.0f, 434.7f),
     ...
     * @see [Firmware Issue #4948](https://github.com/meshtastic/firmware/issues/4948#issuecomment-2394926135)
     */
    PH_868(Config.LoRaConfig.RegionCode.PH_868, "Philippines 868MHz", 868.0f, 869.4f),
     ...
     * @see [Firmware Issue #4948](https://github.com/meshtastic/firmware/issues/4948#issuecomment-2394926135)
     */
    PH_915(Config.LoRaConfig.RegionCode.PH_915, "Philippines 915MHz", 915.0f, 918.0f),

    /** 2.4 GHZ WLAN Band equivalent. Only for SX128x chips. */
    LORA_24(Config.LoRaConfig.RegionCode.LORA_24, "2.4 GHz", 2400.0f, 2483.5f, wideLora = true),
     ...
     */
    ANZ_433(Config.LoRaConfig.RegionCode.ANZ_433, "Australia / New Zealand 433MHz", 433.05f, 434.79f),
     ...
     */
    KZ_433(Config.LoRaConfig.RegionCode.KZ_433, "Kazakhstan 433MHz", 433.075f, 434.775f),
     ...
     * @see [Firmware Issue #7204](https://github.com/meshtastic/firmware/issues/7204)
     */
    KZ_863(Config.LoRaConfig.RegionCode.KZ_863, "Kazakhstan 863MHz", 863.0f, 868.0f, wideLora = true),
     ...
     */
    NP_865(Config.LoRaConfig.RegionCode.NP_865, "Nepal 865MHz", 865.0f, 868.0f, wideLora = false),
     ...
     */
    BR_902(Config.LoRaConfig.RegionCode.BR_902, "Brazil 902MHz", 902.0f, 907.5f, wideLora = false),
    ;

    companion object {
        fun fromRegionCode(regionCode: Config.LoRaConfig.RegionCode): RegionInfo? =
            entries.find { it.regionCode == regionCode }
    }
}

enum class ChannelOption(
    val modemPreset: Config.LoRaConfig.ModemPreset,
    val labelRes: StringResource,
    val bandwidth: Float,
) {
    // Grouped by range and speed for better readability
    VERY_LONG_SLOW(Config.LoRaConfig.ModemPreset.VERY_LONG_SLOW, Res.string.label_very_long_slow, 0.0625f),
    LONG_TURBO(Config.LoRaConfig.ModemPreset.LONG_TURBO, Res.string.label_long_turbo, 0.500f),
    LONG_FAST(Config.LoRaConfig.ModemPreset.LONG_FAST, Res.string.label_long_fast, 0.250f),
    LONG_MODERATE(Config.LoRaConfig.ModemPreset.LONG_MODERATE, Res.string.label_long_moderate, 0.125f),
    LONG_SLOW(Config.LoRaConfig.ModemPreset.LONG_SLOW, Res.string.label_long_slow, 0.125f),
    MEDIUM_FAST(Config.LoRaConfig.ModemPreset.MEDIUM_FAST, Res.string.label_medium_fast, 0.250f),
    MEDIUM_SLOW(Config.LoRaConfig.ModemPreset.MEDIUM_SLOW, Res.string.label_medium_slow, 0.250f),
    SHORT_FAST(Config.LoRaConfig.ModemPreset.SHORT_FAST, Res.string.label_short_fast, 0.250f),
    SHORT_SLOW(Config.LoRaConfig.ModemPreset.SHORT_SLOW, Res.string.label_short_slow, 0.250f),
    SHORT_TURBO(Config.LoRaConfig.ModemPreset.SHORT_TURBO, Res.string.label_short_turbo, 0.500f),
    ;
    ...
    companion object {
        ...
        fun from(modemPreset: Config.LoRaConfig.ModemPreset?): ChannelOption? {
