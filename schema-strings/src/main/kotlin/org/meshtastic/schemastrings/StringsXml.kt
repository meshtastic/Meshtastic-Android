 ...
 */
object StringsXml {
    const val GENERATED_NOTICE =
        "<!-- Generated by ./gradlew :schema-strings:sync from the protobufs field metadata. " +
    ...
    fun render(header: String, bodies: Map<String, String>, notice: String? = GENERATED_NOTICE): String = buildString {
        append(header)
        append("<resources>\n")
