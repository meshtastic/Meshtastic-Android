...
## Description
Brand identity, color palette, accessibility, and icon specifications for Meshtastic clients. All UI must comply with these standards. Before making UI changes, fetch the latest version of the [Meshtastic Client Design Standards](https://raw.githubusercontent.com/meshtastic/design/refs/heads/master/standards/meshtastic_design_standards_latest.md).
...
- **Launcher icons:** Use separate SVGs for foreground and background, 108px square, with the logo 58px wide/high. Regenerate with [Image Asset Studio](https://developer.android.com/studio/write/image-asset-studio#create-adaptive). Name the icon `ic_launcher2`.
