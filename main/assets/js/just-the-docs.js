...
function initSearch() {
  ...
  request.open('GET', '/Meshtastic-Android/main/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/Meshtastic-Android/main/assets/css/just-the-docs-' + theme + '.css');
}
