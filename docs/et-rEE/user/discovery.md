...
- **Join** — switch to the offered channel and preset (retunes the node and reboots). Kui pakkumine sobib praeguse sageduspesaga, lisab toiming **Lisa kanal** selle taaskäivituseta.
