...
| -------- | ---- | -------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| Hea      | Full | SNR above `limit`                                              | Comfortably above the demodulation floor — a healthy connection.                    |
| Rahuldav | 3    | less than 5.5 dB below `limit`                 | Decodable, but approaching the floor.                                               |
| Halb     | 2    | 5.5 dB to 7.5 dB below `limit` | At the edge of what the preset can recover.                                         |
| Puudub   | 1    | more than 7.5 dB below `limit`                 | Far below the preset's floor; further packets from this node are likely to be lost. |
