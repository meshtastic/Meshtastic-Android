...
| Изпол. на канала | % of local airtime in use                       | 0–100%                                                             |
| Изпол. на ефира  | % of the last hour this node spent transmitting | 0–100%                                                             |
...
| Тегло                                 | kg or lb             | Card only — load cells, such as a beehive scale                                                                                                             |
| Разстояние                            | mm or in             | Card only — water level, from a distance sensor                                                                                                             |
