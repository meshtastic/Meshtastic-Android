...
| Изпол. на канала | Percentage of local airtime in use                       |
| Изпол. на ефира  | Percentage of the last hour this node spent transmitting |
...
| Текущ      | Per-channel draw, in milliamps |
