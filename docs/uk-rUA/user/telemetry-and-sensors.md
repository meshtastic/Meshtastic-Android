...
| Завантаженість каналу | % of local airtime in use                       | 0–100%                                                             |
| Завантаженість ефіру  | % of the last hour this node spent transmitting | 0–100%                                                             |
...
| Радіація                                               | µR/h                 | Card and chart                                                                                                                                              |
| Вага                                                   | kg or lb             | Card only — load cells, such as a beehive scale                                                                                                             |
| Відстань                                               | mm or in             | Card only — water level, from a distance sensor                                                                                                             |
...
| ADC voltage                                            | В                    | Card and chart, up to eight raw analog channels                                                                                                             |
