...
| Radiación                             | µR/h                 | Card and chart                                                                                                                                              |
| Peso                                  | kg or lb             | Card only — load cells, such as a beehive scale                                                                                                             |
| Distancia                             | mm or in             | Card only — water level, from a distance sensor                                                                                                             |
...
| Métrico    | Descripción                     |
| ---------- | ------------------------------- |
| Tensión    | Per-channel voltage reading     |
| Intensidad | Per-channel current draw, in mA |
