...
| Endurræsa        | Restarts the radio                                                                                     |
| Slökkva          | Powers the radio down                                                                                  |
| Grunnstilla      | Returns every setting to its factory default                                                           |
| Endurræsa NodeDB | Clears the radio's node database. This dialog carries a **Preserve Favorites?** switch |
