...
| 🔴   | Aftengd             | No active connection. The app retries automatically, with a growing delay between attempts |
| ⚪    | Radíó er í svefnham | The radio is in light sleep — the app is waiting for it to wake and reconnect, not failing                 |
