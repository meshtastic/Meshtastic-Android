...
| 正式名称       | 表示名（最大 39 文字）                                                                                                                                                                                                                                |
| 短縮名        | 4 文字の短縮名                                                                                                                                                                                                                                     |
| ステータスメッセージ | A short free-text status other nodes display alongside your node — up to 80 bytes, cleared with the **✕** in the field. Needs firmware 2.8 or newer, and is absent otherwise                                 |
...
設定を変更したら、「**保存**」をタップして構成を無線機に書き込みます。 The radio may reboot to apply changes.
