...
| ----- | ---- | ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| 良     | 3    | RSSI better than `-115 dBm` **AND** SNR better than `-7 dB`                               | Signal is both loud and clear — healthy connection.     |
...
| 不良    | 1    | Falls between Fair and None thresholds                                                    | At the edge of range or experiencing interference.      |
| なし    | 0    | RSSI worse than `-126 dBm` **AND** SNR worse than `-15 dB`                                | Transmission completely buried in noise.                |
