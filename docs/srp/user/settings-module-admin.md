...
| Поновно покретање                   | Restarts the radio                                                                                     |
| Искључи                             | Powers the radio down                                                                                  |
| Рестартовање на фабричка подешавања | Returns every setting to its factory default                                                           |
| Ресетовање базе чворова             | Clears the radio's node database. This dialog carries a **Preserve Favorites?** switch |
