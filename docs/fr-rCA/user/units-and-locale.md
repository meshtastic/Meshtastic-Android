...
Sur Android, vos préférences de mesure sont déterminées par les paramètres de **Langue et Région** de votre système. Sur l'application de bureau (JVM), la `Locale` par défaut de la JVM est utilisée.
...
| Vos réglages                             | Vous voyez              |
| ---------------------------------------- | ----------------------- |
| Métrique                                 | 12.0 mm |
| Impérial (États-Unis) | 0.47 in |
