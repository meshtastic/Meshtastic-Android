...
| UtilCanal               | % of local airtime in use                       | 0–100%                                                             |
| UtilAir                 | % of the last hour this node spent transmitting | 0–100%                                                             |
...
| Métrique | Unit    | Notes                                           |
| -------- | ------- | ----------------------------------------------- |
| Temp sol | °C / °F | Reported alongside soil moisture by soil probes |
| Hum sol  | %       | Volumetric water content                        |
...
| Poids                                 | kg or lb             | Card only — load cells, such as a beehive scale                                                                                                             |
...
| Actif    | Per-channel current draw, in mA |
