...
| Udaljenost                            | mm or in             | Card only — water level, from a distance sensor                                                                                                             |
...
| Струја  | Per-channel current draw, in mA |
