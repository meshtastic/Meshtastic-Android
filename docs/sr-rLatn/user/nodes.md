...
| Изгубљено и нађено | Sends its position to the default channel as a text message at regular intervals, to help recover a lost node                                          |
...
| Poslednji put viđeno | ![Last heard](../../assets/screenshots/nodes_last_heard.png)  |
