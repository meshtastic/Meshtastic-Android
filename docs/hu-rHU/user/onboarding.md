...
|                               |                                                                                                                                     |
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| **Stay Connected Anywhere**   | Kommunikálj a barátaiddal és a közösségeddel mobilhálózat nélkül, a hálózaton kívül is.                             |
| **Create Your Own Networks**  | Egyszerűen állíts be privát mesh hálózatokat a biztonságos és megbízható kommunikáció érdekében távoli területeken. |
| **Track and Share Locations** | Oszd meg a helyzeted valós időben, és tartsd összehangoltan a csoportot a beépített GPS-funkciókkal.                |
