...
| Sugárzás                              | µR/h                 | Card and chart                                                                                                                                              |
| Súly                                  | kg or lb             | Card only — load cells, such as a beehive scale                                                                                                             |
| Távolság                              | mm or in             | Card only — water level, from a distance sensor                                                                                                             |
...
| Áramerősség | Per-channel current draw, in mA |
