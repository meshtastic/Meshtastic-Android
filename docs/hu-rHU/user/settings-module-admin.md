...
| Setting                                                         | Leírás                                                                                                                                                                                   |
| --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Elfogadom.                                      | Explicit consent to transmit your node data, including an approximate position, unencrypted. Map reporting does not start without it                                     |
...
| .CSV mentése a tárhelyre (csak ESP32) | Log received test data to the radio's own filesystem. ESP32 hardware only |
...
| Újraindítás                      | Restarts the radio                                                                                     |
| Leállítás                        | Powers the radio down                                                                                  |
| Gyári beállítások visszaállítása | Returns every setting to its factory default                                                           |
| NodeDB törlése                   | Clears the radio's node database. This dialog carries a **Preserve Favorites?** switch |
