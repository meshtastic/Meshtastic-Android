...
| Setting                                                | Opis                                                                                                                                                                                     |
| ------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Zgadzam się.                           | Explicit consent to transmit your node data, including an approximate position, unencrypted. Map reporting does not start without it                                     |
...
| Uruchom ponownie     | Restarts the radio                                                                                     |
| Wyłącz               | Powers the radio down                                                                                  |
| Ustawienia fabryczne | Returns every setting to its factory default                                                           |
| Zresetuj NodeDB      | Clears the radio's node database. This dialog carries a **Preserve Favorites?** switch |
