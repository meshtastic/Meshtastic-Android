...
| 🔴   | 연결 끊김 | No active connection. The app retries automatically, with a growing delay between attempts |
| ⚪    | 절전모드  | The radio is in light sleep — the app is waiting for it to wake and reconnect, not failing                 |
