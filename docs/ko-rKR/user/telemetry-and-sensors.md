...
| 복사                                    | µR/h                 | Card and chart                                                                                                                                              |
| 무게                                    | kg or lb             | Card only — load cells, such as a beehive scale                                                                                                             |
| 거리                                    | mm or in             | Card only — water level, from a distance sensor                                                                                                             |
...
| 전류     | Per-channel current draw, in mA |
