...
| Setting                                    | 설명                                                                                                                                                                                     | 기본값      |
| ------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| 역할                                         | Node behavior (Client, Router, etc.) — each option carries its own description in the picker. Choosing Router asks for confirmation | Client   |
| 중계 모드                                      | How the node retransmits messages; each mode is described in the picker                                                                                                                | All      |
...
| Duty Cycle 무시      | Ignore the region's duty-cycle limit. Only legal where you are permitted to                                                                                                      | Off                                       |
| MQTT로 부터 수신 무시     | Drop packets that arrived from MQTT rather than over the air                                                                                                                                     | Off                                       |
| MQTT로 전송 허용        | Allow your packets to be forwarded to MQTT by gateways                                                                                                                                           | Off                                       |
...
| 단위 표시                 | Metric or Imperial on the device's screen                                                                                                                 |
| 12시간제 보기              | Show the device clock as 12-hour rather than 24-hour                                                                                                      |
...
| Setting                          | 설명                                                                                                                         |
| -------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| WiFi 활성화                         | Enable the WiFi radio (ESP32 devices)                                                                   |
...
| IPv4 모드                          | DHCP, or a static address configured with the four fields below                                                            |
