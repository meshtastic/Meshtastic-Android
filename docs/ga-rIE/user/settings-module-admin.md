...
| Athmhaoinigh              | Restarts the radio                                                                                     |
| Dún                       | Powers the radio down                                                                                  |
| Athshocraigh an fhactaraí | Returns every setting to its factory default                                                           |
| Athshocraigh NodeDB       | Clears the radio's node database. This dialog carries a **Preserve Favorites?** switch |
