...
| Metrico               | Unit    | Note                                            |
| --------------------- | ------- | ----------------------------------------------- |
| Temperatura Del Suolo | °C / °F | Reported alongside soil moisture by soil probes |
| Umidità del Suolo     | %       | Volumetric water content                        |
...
| Radiazione                            | µR/h                 | Card and chart                                                                                                                                              |
| Peso                                  | kg or lb             | Card only — load cells, such as a beehive scale                                                                                                             |
| Distanza                              | mm or in             | Card only — water level, from a distance sensor                                                                                                             |
...
| Attuale  | Per-channel current draw, in mA |
