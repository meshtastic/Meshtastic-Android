...
| Setting            | Beskrivning                                                                                                                     |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------- |
| Aktiverad          | Publish to the public map at all                                                                                                |
...
| Uppdateringsintervall för enhetsdata         | How often to report battery, uptime and channel utilisation                                                                                                                       |
...
| PTT-stift                          | GPIO pin for the push-to-talk button |
...
| Setting             | Beskrivning                                                                                                                                                                      |
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Själva statustexten | Up to 80 characters. The **✕** in the field clears it. (That is the app's own label for the field, verbatim.) |
