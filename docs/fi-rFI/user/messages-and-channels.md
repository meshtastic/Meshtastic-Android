...
Jokaisessa Meshtastic-radiossa on oletuksena **LongFast**-kanava. Se on salattu tunnetulla oletusavaimella, joten kuka tahansa, joka käyttää Meshtasticia samalla esiasetuksella, voi lukea sen.
...
2. Valitse keskustelu tai napauta radiota Radiot-luettelossa.
...
- **Kosketa pitkään valitaksesi** yhden tai useamman keskustelun ja käytä sitten toimintopalkkia niiden **kiinnittämiseen**, **merkitsemiseen lukemattomiksi**, mykistämiseen tai poistamiseen yhdessä. Kiinnitetyissä keskusteluissa näkyy nuppineulamerkki, ja ne siirtyvät **oman osionsa alkuun**.
...
| Tila                                                           | Merkitys                                                                                                                                                                                                                                                                               |
| -------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Lähetetään…                                                    | Jonossa tai jo välitetty radiolle, mutta lopullista tilaa ei ole vielä vahvistettu. Molemmissa vaiheissa näkyy sama teksti, mutta kuvake ja väri vaihtuvat etenemisen mukaan — jonossa näkyy keltainen lähetyspilvi, ja kun radio on vastaanottanut sen, sininen nuoli |
...
Sovellus lähettää kaikki kirjoittamasi viestit samalla oletusprioriteetilla — valittavana ei ole hätä- tai hälytysprioriteettia, eikä mikään sovelluksessa nosta suoraviestiä kanavalähetyksen edelle. Mahdollinen priorisointi tehdään laiteohjelmistossa, ei tässä. (Sovellus merkitsee osan omasta sisäisestä liikenteestään, kuten järjestelmänvalvojan paketit ja reitiselvityspaketit, luotettaviksi tai taustaliikenteeksi, mutta sitä ei voi hallita viestinkirjoituskentästä.)
