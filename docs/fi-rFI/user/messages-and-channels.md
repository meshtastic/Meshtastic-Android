...
| No radio interface                                     | Lähetykseen ei ole käytettävissä radioliitäntää | Check that your radio is connected and available.                                                                               |
| Toimitus mesh-verkkoon epäonnistui                     | Uudelleenyritysten enimmäismäärä saavutettu     | Move closer, improve signal, or wait for mesh conditions to improve.                                                            |
| Channel/key mismatch                                   | Destination channel/key does not match          | Verify both nodes share the same channel and PSK.                                                                               |
| Viesti on liian suuri lähetettäväksi                   | Viesti ylittää sallitun enimmäiskoon            | Shorten the message and try again.                                                                                              |
| No app response                                        | App or plugin did not respond to the request    | Retry or check the destination app or module state.                                                                             |
| Duty cycle limit                                       | Alueellinen lähetysajan raja saavutettu         | Wait for the duty cycle window to reset.                                                                                        |
