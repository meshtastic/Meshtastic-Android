...
| Käytä Fahrenheit yksikköä             | Käytä radion näytössä Fahrenheit-asteita. This is the node's screen only — the app follows your phone's locale, see [Units & Locale](units-and-locale) |
