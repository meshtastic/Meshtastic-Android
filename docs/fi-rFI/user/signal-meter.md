...
| ----------- | ------ | -------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| Hyvä        | Full   | SNR yli `rajan`                                                | Selvästi demodulointirajan yläpuolella — yhteys on hyvä.                                              |
| Kohtalainen | 3      | alle 5.5 dB `rajan` alapuolella                | Voidaan vielä purkaa, mutta lähellä rajaa.                                                            |
| Huono       | 2      | 5.5–7.5 dB `rajan` alapuolella | Esiasetuksen vastaanottokyvyn rajalla.                                                                |
| ei mitään   | 1      | yli 7.5 dB `rajan` alapuolella                 | Selvästi esiasetuksen rajan alapuolella; tältä radiolta tulevia lisäpaketteja todennäköisesti katoaa. |
...
A great RSSI paired with a one- or two-bar rating (None or Bad) points to local interference, not distance. Halpa virtalähde, häiriöinen tietokone tai lähellä oleva lähetin voi aiheuttaa niin paljon kohinaa, että muuten vahva signaali peittyy.
