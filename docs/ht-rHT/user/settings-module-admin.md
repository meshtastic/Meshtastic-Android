...
| Rekòmanse             | Restarts the radio                                                                                     |
| Fèmen                 | Powers the radio down                                                                                  |
| Reyajiste nan faktori | Returns every setting to its factory default                                                           |
| Reyajiste NodeDB      | Clears the radio's node database. This dialog carries a **Preserve Favorites?** switch |
