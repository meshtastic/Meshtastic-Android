...
| Ponovno pokreni                | Restarts the radio                                                                                     |
| Isključi                       | Powers the radio down                                                                                  |
| Vraćanje na tvorničke postavke | Returns every setting to its factory default                                                           |
| Resetiraj NodeDB bazu          | Clears the radio's node database. This dialog carries a **Preserve Favorites?** switch |
