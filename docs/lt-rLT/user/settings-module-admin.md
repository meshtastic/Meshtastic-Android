...
| Perkrauti             | Restarts the radio                                                                                     |
| Išjungti              | Powers the radio down                                                                                  |
| Gamyklinis atstatymas | Returns every setting to its factory default                                                           |
| NodeDB perkrauti      | Clears the radio's node database. This dialog carries a **Preserve Favorites?** switch |
