...
picked a different base map yourself in between. On **F-Droid**/**Desktop**, a downloaded offline area keeps
rendering on its own; the pill is purely informational there.
