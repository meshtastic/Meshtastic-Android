...
| Metrický                              | Unit                 | Where it appears                                                                                                                                            |
| ------------------------------------- | -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| Radiace                               | µR/h                 | Card and chart                                                                                                                                              |
| Hmotnost                              | kg or lb             | Card only — load cells, such as a beehive scale                                                                                                             |
| Vzdálenost                            | mm or in             | Card only — water level, from a distance sensor                                                                                                             |
