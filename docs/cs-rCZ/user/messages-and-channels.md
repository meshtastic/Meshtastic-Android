...
| Chyba                               | Delivery failed — tap the status for the specific reason (see [Delivery Errors](#delivery-errors))                                                                                                                    |
...
| --------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| Žádná trasa                             | No path exists to the destination node                                                                                                                                        | The recipient may be offline or out of mesh range. Try later or move closer.                          |
| No radio interface                      | No radio interface available to send                                                                                                                                          | Check that your radio is connected and available.                                                                     |
| Nepodařilo se doručit do mesh sítě      | Retries exhausted. The same label covers three underlying causes — a relay refusing (NAK), a plain timeout, and running out of retransmits | Move closer, improve signal, or wait for conditions to improve. Tap the error for the specific cause. |
| Rate limited                            | The mesh is throttling you for sending too fast                                                                                                                               | Wait before sending again.                                                                                            |
| Neautorizováno                          | The destination refused the request                                                                                                                                           | Check you have the right channel and keys for that node.                                                              |
...
| Nepodařilo se odeslat šifrovanou zprávu | Encryption failed for this direct message                                                                                                                                     | Verify both nodes have exchanged keys and are on compatible firmware.                                                 |
...
| Zpráva je příliš dlouhá pro odeslání    | Message exceeds maximum payload size                                                                                                                                          | Shorten the message and try again.                                                                                    |
