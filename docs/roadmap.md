...
2. **Migrate to Navigation 3 Scene-based architecture** — leverage the first stable release of Nav 3 to support multi-pane layouts on Large (1200dp) and Extra-large (1600dp) displays (Android 16 QPR3).
