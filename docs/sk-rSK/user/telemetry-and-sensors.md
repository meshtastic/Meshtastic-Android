...
| Radiácia                              | µR/h                 | Card and chart                                                                                                                                              |
| Hmotnosť                              | kg or lb             | Card only — load cells, such as a beehive scale                                                                                                             |
| Vzdialenosť                           | mm or in             | Card only — water level, from a distance sensor                                                                                                             |
...
| Prúd    | Per-channel current draw, in mA |
