...
| Reštartovať                   | Restarts the radio                                                                                     |
| Vypnúť                        | Powers the radio down                                                                                  |
| Obnova do výrobných nastavení | Returns every setting to its factory default                                                           |
| Reset databázy uzlov          | Clears the radio's node database. This dialog carries a **Preserve Favorites?** switch |
