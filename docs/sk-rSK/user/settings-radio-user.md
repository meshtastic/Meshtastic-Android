...
| ------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| Rola                                       | Node behavior (Client, Router, etc.) — each option carries its own description in the picker. Choosing Router asks for confirmation | Klient     |
| Rebroadcast Mode                           | How the node retransmits messages; each mode is described in the picker                                                                                                                | Všetky     |
...
| Setting                          | Popis                                                                                                                      |
| -------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| WiFi zapnutá                     | Enable the WiFi radio (ESP32 devices)                                                                   |
...
| IPv4 režim                       | DHCP, or a static address configured with the four fields below                                                            |
