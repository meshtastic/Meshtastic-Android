...
| Kanalauslastung | % of local airtime in use                       | 0–100%                                                             |
| Sendezeit       | % of the last hour this node spent transmitting | 0–100%                                                             |
...
| Metrisch        | Einheit | Knoten                                          |
| --------------- | ------- | ----------------------------------------------- |
| Bodentemperatur | °C / °F | Reported alongside soil moisture by soil probes |
| Bodenfeuchte    | %       | Volumetric water content                        |
...
| Metrisch                              | Einheit              | Where it appears                                                                                                                                            |
| ------------------------------------- | -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| Strahlung                             | µR/h                 | Card and chart                                                                                                                                              |
| Gewicht                               | kg or lb             | Card only — load cells, such as a beehive scale                                                                                                             |
| Distanz                               | mm or in             | Card only — water level, from a distance sensor                                                                                                             |
...
| Stromstärke | Per-channel current draw, in mA |
