...
| Radyasyon                             | µR/h                 | Card and chart                                                                                                                                              |
| Ağırlık                               | kg or lb             | Card only — load cells, such as a beehive scale                                                                                                             |
| Mesafe                                | mm or in             | Card only — water level, from a distance sensor                                                                                                             |
...
| Akım   | Per-channel current draw, in mA |
