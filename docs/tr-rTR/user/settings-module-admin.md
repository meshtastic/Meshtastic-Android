...
| Setting                                              | Açıklaması                                                                                                                                                                               |
| ---------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Katılıyorum.                         | Explicit consent to transmit your node data, including an approximate position, unencrypted. Map reporting does not start without it                                     |
...
| .CSV'yi depolamada kaydet (sadece ESP32) | Log received test data to the radio's own filesystem. ESP32 hardware only |
...
| Çevre metrikleri Fahrenheit kullan    | Use °F on the device's display. This is the radio's screen only — the app follows your phone's locale, see [Units & Locale](units-and-locale) |
...
| Yeniden başlat   | Restarts the radio                                                                                     |
| Kapat            | Powers the radio down                                                                                  |
| Fabrika ayarları | Returns every setting to its factory default                                                           |
| NodeDB sıfırla   | Clears the radio's node database. This dialog carries a **Preserve Favorites?** switch |
