...
| 頻道利用率         | % of local airtime in use                       | 0–100%                                                             |
| 空中時間使用率       | % of the last hour this node spent transmitting | 0–100%                                                             |
...
| 公制（公里/公尺） | 單位      | 備註                                              |
| --------- | ------- | ----------------------------------------------- |
| 土壤溫度      | °C / °F | Reported alongside soil moisture by soil probes |
| 土壤濕度      | %       | Volumetric water content                        |
...
| 輻射                                    | µR/h                 | Card and chart                                                                                                                                              |
| 重量                                    | kg or lb             | Card only — load cells, such as a beehive scale                                                                                                             |
...
| ADC voltage                           | 伏特                   | Card and chart, up to eight raw analog channels                                                                                                             |
...
| 目前        | Per-channel current draw, in mA |
