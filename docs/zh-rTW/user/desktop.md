...
| 訊息傳送                                                  | ✓       | ✓   | 完全對等                                                                                                                                                                                                                                            |
| 節點清單                                                  | ✓       | ✓   | 完全對等                                                                                                                                                                                                                                            |
| 地圖                                                    | ✓       | ✓   | Interactive MapLibre map, with base map and overlay pickers and custom tile sources. Offline terrain (hillshade and contours) can be downloaded; offline base-map packs and local `.mbtiles` archives cannot |
