...
| Média  | 2    | less than 5.5 dB below `limit`                 | Decodable, but approaching the floor.                                               |
| Ruim   | 1    | 5.5 dB to 7.5 dB below `limit` | At the edge of what the preset can recover.                                         |
