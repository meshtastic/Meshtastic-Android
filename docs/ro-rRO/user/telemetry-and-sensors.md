...
| Umid sol | %       | Volumetric water content                        |
...
| Radiație                              | µR/h                 | Card and chart                                                                                                                                              |
| Greutate                              | kg or lb             | Card only — load cells, such as a beehive scale                                                                                                             |
| Distanță                              | mm or in             | Card only — water level, from a distance sensor                                                                                                             |
...
| Actual   | Per-channel current draw, in mA |
