...
|                               |                                                                                                                    |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| **Stay Connected Anywhere**   | Comunicați în afara grilei cu prietenii și comunitatea dvs. fără serviciu celular. |
| **Create Your Own Networks**  | Înființarea cu ușurință a rețelelor private de plasare pentru comunicații sigure și fiabile în zonele îndepărtate; |
| **Track and Share Locations** | Partajați-vă locația în timp real și păstrați grupul coordonat cu funcții GPS integrate.           |
