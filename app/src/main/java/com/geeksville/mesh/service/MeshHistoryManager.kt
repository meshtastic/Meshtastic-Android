        ...
        internal fun buildStoreForwardHistoryRequest(
            ...
            val history =
                StoreAndForward.History(
                    last_request = if (lastRequest > 0) lastRequest else 0,
                    window = if (historyReturnWindow > 0) historyReturnWindow else 0,
                    history_messages = if (historyReturnMax > 0) historyReturnMax else 0,
                )
