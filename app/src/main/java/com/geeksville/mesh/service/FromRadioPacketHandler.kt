...
constructor(
    ...
    fun handleFromRadio(proto: FromRadio) {
        ...
        val mqttClientProxyMessage = proto.mqttClientProxyMessage
        ...
        when {
            ...
            mqttClientProxyMessage != null -> mqttManager.handleMqttProxyMessage(mqttClientProxyMessage)
            ...
            else -> Logger.d { "Dispatcher ignoring unknown variant in $proto" }
        }
    }
}
