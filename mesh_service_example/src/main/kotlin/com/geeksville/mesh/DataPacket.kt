 ...
 *
 * @param to A nodeID string, or ID_BROADCAST for broadcast
 * @param dataType A port number for this packet (formerly called DataType, see portnums.proto for new usage
 *   instructions)
 * @param from A nodeID string, or ID_LOCAL for localhost
 * @param time Milliseconds since 1970
 * @param id 0 means unassigned
 * @param channel Channel index
 * @param wantAck If true, the receiver should send an ack back
 */
@Serializable
