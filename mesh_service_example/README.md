...
The [AIDL](../core/service/src/main/aidl/org/meshtastic/core/service/IMeshService.aidl) is defined in the `core:service` module and is used to interact with the mesh network.
