...
| `bandwidth` | Integer | Numeric input outside `LORA_24`; region/target-aware dropdown in `LORA_24` | Visible only when `use_preset = false`; unsupported stored `LORA_24` values remain visible and block Save until replaced |
