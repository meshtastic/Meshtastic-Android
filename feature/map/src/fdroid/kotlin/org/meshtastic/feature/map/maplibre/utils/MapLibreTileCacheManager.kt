...
/**
 * Simplified tile cache manager for MapLibre.
 * Provides basic cache clearing functionality.
 * Note: MapLibre automatically caches tiles via HTTP caching as you view the map.
 */
class MapLibreTileCacheManager(private val context: Context) {
    ...
    /**
     * Clears the ambient cache (automatic HTTP tile cache).
     * MapLibre automatically caches tiles in the "ambient cache" as you view the map.
     * This method clears that cache to free up storage space.
     */
    suspend fun clearCache() = withContext(Dispatchers.IO) {
        ...
        offlineManager.listOfflineRegions(object : OfflineManager.ListOfflineRegionsCallback {
            override fun onList(offlineRegions: Array<OfflineRegion>?) {
                ...
                Timber.tag("MapLibreTileCacheManager").d("Cleaning up ${offlineRegions.size} offline regions from old implementation")
    ...
    /**
     * Sets the maximum size for the ambient cache in bytes.
     * Default is typically 50MB. Call this to increase or decrease the cache size.
     */
    fun setMaximumAmbientCacheSize(sizeBytes: Long, callback: OfflineManager.FileSourceCallback? = null) {
        ...
        offlineManager.setMaximumAmbientCacheSize(sizeBytes, callback ?: object : OfflineManager.FileSourceCallback {
            override fun onSuccess() {
