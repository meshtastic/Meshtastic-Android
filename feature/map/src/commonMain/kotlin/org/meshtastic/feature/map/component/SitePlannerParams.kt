...
data class SitePlannerParams(
     ...
     * hand the result to a native host bridge (`bridge=1`) rather than the share sheet.
     */
    ...
    companion object {
        // Meshtastic-typical stock defaults; all editable in the dialog before submission.
        const val DEFAULT_TX_POWER_WATTS: Double = 0.1
        const val DEFAULT_TX_FREQ_MHZ: Double = 906.0
