...
class TracerouteNodeSelectionTest {
    ...
    private fun nodeWithPosition(num: Int, latI: Int = num * 100000, lonI: Int = num * 200000): Node =
        Node(num = num, position = Position.Builder().also { wb ->wb.latitude_i = latI; wb.longitude_i = lonI}.build())
    ...
    fun overlayWithSnapshot_usesSnapshotPositions() {
        ...
        val snapshotPositions =
            mapOf(
                10 to Position.Builder().also { wb ->wb.latitude_i = 400000000; wb.longitude_i = -700000000}.build(),
                20 to Position.Builder().also { wb ->wb.latitude_i = 410000000; wb.longitude_i = -710000000}.build(),
            )
        val liveNodes =
            listOf(
    ...
    fun overlayWithSnapshot_filtersToOverlayNodes() {
        ...
        val snapshotPositions =
            mapOf(
                10 to Position.Builder().also { wb ->wb.latitude_i = 400000000; wb.longitude_i = -700000000}.build(),
                20 to Position.Builder().also { wb ->wb.latitude_i = 410000000; wb.longitude_i = -710000000}.build(),
                30 to Position.Builder().also { wb ->wb.latitude_i = 420000000; wb.longitude_i = -720000000}.build(),
            )
        val result =
            tracerouteNodeSelection(
                tracerouteOverlay = overlay,
    ...
    fun getNodeOrFallback_usedForSnapshotNodeLookup() {
        ...
        val snapshotPositions = mapOf(10 to Position.Builder().also { wb ->wb.latitude_i = 400000000; wb.longitude_i = -700000000}.build())
