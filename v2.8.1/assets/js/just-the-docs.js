...
function initSearch() {
  ...
  request.open('GET', '/Meshtastic-Android/v2.8.1/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/Meshtastic-Android/v2.8.1/assets/css/just-the-docs-' + theme + '.css');
}
