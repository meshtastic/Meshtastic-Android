...
function initSearch() {
  ...
  request.open('GET', '/Meshtastic-Android/v2.8.2/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/Meshtastic-Android/v2.8.2/assets/css/just-the-docs-' + theme + '.css');
}
