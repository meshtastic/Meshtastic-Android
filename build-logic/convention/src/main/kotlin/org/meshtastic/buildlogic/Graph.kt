...
internal enum class PluginType(val id: String, val ref: String, val style: String) {
    ...
    KmpLibrary( // Added for Kotlin Multiplatform libraries
...
private abstract class GraphDumpTask : DefaultTask() {
    ...
    operator fun invoke() {
        ...
        legend.get().asFile.writeText(legend()) // Corrected line
    ...
    private fun legend() = buildString {
        ...
        listOf(
            ...
            "kmp-library" to PluginType.KmpLibrary, // Added for KMP
        ).forEach { (name, type) ->
