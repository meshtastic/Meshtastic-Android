...
internal class BurningManPmtilesRenderer(file: File) {
    private val archive = LocalPmtiles(file)

    fun tile(x: Int, y: Int, zoom: Int): Bitmap? = archive.tile(x, y, zoom)?.let(::rasterize)
...
private const val PATH_KIND = "path"
private const val PEDESTRIAN_KIND_DETAIL = "pedestrian"
private val EXCLUDED_PATH_KINDS = setOf("footway", "cycleway", "track")
private val PLAYA_COLOR = Color.rgb(234, 234, 234)
private val LANDCOVER_COLOR = Color.rgb(228, 221, 202)
private val LANDUSE_COLOR = Color.rgb(238, 228, 196)
private val WATER_COLOR = Color.rgb(144, 198, 231)
private val ROAD_COLOR = Color.rgb(255, 255, 255)
private val MINOR_ROAD_COLOR = Color.rgb(254, 181, 196)
private const val ROAD_WIDTH = 4f
private const val PEDESTRIAN_ROAD_WIDTH = 3f
